...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The _queue variable was of type List, instead of type Queue, 
    // which caused the values ​​to be added first to last and last to be first in the List.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The GetNextPerson function was missing a condition to add the person to the queue 
    // if the person had 0 turns or less.
